...
const Projects = () => {
    return (
        <div className='bg-violet-500 text-white py-32  mx-auto' id='Projects'>
            <h1 className='underline text-4xl text-white text-left m-10 text-bold pb-10 w-[85%] mx-auto '>PROJECTS</h1>
            <div className='container mx-auto text-left justify-between  pb-5 w-[85%] '>
